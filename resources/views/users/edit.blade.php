...
@method("PUT")
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control rounded-3 @error('name') is-invalid @enderror" placeholder="Enter your name" value="{{ $user->name}}">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" class="form-control rounded-3 @error('email') is-invalid @enderror" placeholder="Enter your email" value="{{ $user->email}}">
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
  ...
  {{-- Roles --}}
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ route('users.index') }}" class="text-muted text-decoration-none">← Back to Users</a>
                    </div>
                </form>
            </div>
        </div>
