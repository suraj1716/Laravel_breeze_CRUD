        ...
        <div class="card border-0 shadow-lg rounded-4 p-4" style="max-width: 1000px; width: 100%;">
            <div class="card-body">
                ...
                <div class="text-center mb-1">
                    <a href="{{ route('admin.category.create') }}" class="btn btn-success w-100 py-2 rounded-3 shadow-sm">
                        + Create New Category
                    </a>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td><img src="{{ asset($category->image) }}" style="width: 100px; height: 70px;" alt="Category Image"/></td>
